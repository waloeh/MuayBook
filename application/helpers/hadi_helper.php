<?php  
//fungi untuk menampilkan waktu dan tanggal
function waktu() {
...
//untuk membuat format tanggal menjadi indo
function tgl_indonesia($tgl) {
	$tanggal = substr($tgl,8,2);
	$nama_bulan = array("Januari", "Februari", "Maret", "April", "Mei", "juni", "July", "Agustus", "September","Oktober", "November", "Desember");
	$bulan = $nama_bulan[substr($tgl,5,2) - 1];
	$tahun = substr($tgl,0,4);
	return $tanggal.' '.$bulan.' '.$tahun;
}
//fungsi untuk mengunbah susunan format tanggal
